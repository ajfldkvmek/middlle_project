...
var e = {
	...
	//START : 27 goToInsertMeet
	goToInsertMeet:function(){
		var url = '/nawa/meet/meetlist.jsp';
		 // meetlist.jsp에서 insertMeet 서블릿으로 이동하는 코드
        window.location.href = url.replace('meetlist.jsp', '/meet/controller/insertMeet'); 
