		...
		<div class="container">
			...
			<div class="dropdown ms-1 ms-lg-0">
				<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img class="avatar-img rounded-circle" src="/nawa/assets/images/avatar/img.png" alt="avatar" onclick="javascript:location.href='signin.do'">
				</a>
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="/nawa/assets/images/avatar/01.jpg" alt="avatar">
							</div>
							<div>
