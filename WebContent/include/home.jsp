		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<h1 class="mb-0 display-6">다양한 소모임 <br>동네친구와 함께! <br>
					<span class="position-relative">커먼
						<!-- SVG START -->
				...
				<!-- Content -->
				<p class="my-4 lead">우리 동네의 다양한 모임들과 레슨들을 만나볼 기회.<br> 검증된 전문 강사에게 배워 스킬을 늘려보세요</p>
				
				<!-- Info -->
				<ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>join the meeting</li>
					<!-- <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Get certificate</li> -->
					<li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>Learn with experts </li>
				</ul>

				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					<!-- Button -->
					<a href="#" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">시작해보기</a>
					<!-- Video button -->
